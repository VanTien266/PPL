...
class CheckSuite(unittest.TestCase):
    ...
    #
    #     expect = str(
    #         TypeMismatchInExpression(ArrayCell(Id("a"), [IntLiteral(1), BinaryOp("+", IntLiteral(2), Id("m"))])))
    #     self.assertTrue(TestChecker.test(input, expect, 419))
    #
    ...
    def test_undeclared_function_17(self):
        ...
        input = """
                    ...
                    EndBody.
                   """
        expect = str(TypeMismatchInStatement(Assign(Id("tien"), FloatLiteral(5.5))))
    ...
    def test_undeclared_function_20(self):
        ...
        input = """
                    ...
                    EndBody.
                   """
        expect = str(TypeCannotBeInferred(CallStmt(Id("tien"), [Id("y")])))
    ...
    def test_undeclared_function_26(self):
        ...
        input = """
                   ...
                   """
        expect = str(
            TypeMismatchInStatement(For(Id("x"), FloatLiteral(1.0), BooleanLiteral("true"), IntLiteral(2), ([], []))))
    ...
    def test_undeclared_function_27(self):
        ...
        input = """
                   ...
                   """
        expect = str(
            TypeMismatchInStatement(For(Id("x"), IntLiteral(1), BooleanLiteral("true"), FloatLiteral(2.0), ([], []))))
    ...
    def test_undeclared_function_70(self):
        ...
        input = """
                   ...
                   """
        expect = str(TypeMismatchInStatement(CallStmt(Id("tien"),[IntLiteral(1)])))
    ...
    def test_undeclared_function_73(self):
        input = Program([VarDecl(Id("a"), [2, 3], None), VarDecl(Id("x"), [], None), VarDecl(Id("b"), [2, 3], None),
                         VarDecl(Id("x"), [], None)])
        expect = str(Redeclared(Variable(), "x"))
        self.assertTrue(TestChecker.test(input, expect, 473))

    def test_undeclared_function_74(self):
        input = Program([VarDecl(Id("a"), [2, 3], None), VarDecl(Id("b"), [], None), VarDecl(Id("x"), [2, 3], None),
                         VarDecl(Id("x"), [], None)])
        expect = str(Redeclared(Variable(), "x"))
    ...
    def test_undeclared_function_78(self):
        input = Program([VarDecl(Id("x"), [2, 3], None),
                         FuncDecl(Id("foo"), [VarDecl(Id("x"), [], None), VarDecl(Id("x"), [], None)], ([], []))])
        expect = str(Redeclared(Parameter(), "x"))
        self.assertTrue(TestChecker.test(input, expect, 478))

    def test_undeclared_function_79(self):
        input = Program([VarDecl(Id("x"), [2, 3], None), FuncDecl(Id("foo"), [VarDecl(Id("x"), [], None),
                                                                              VarDecl(Id("y"), [], None),
                                                                              VarDecl(Id("x"), [], None)], ([], []))])
        expect = str(Redeclared(Parameter(), "x"))
    ...
    def test_undeclared_function_80(self):
        input = Program([VarDecl(Id("x"), [2, 3], None), FuncDecl(Id("foo"), [VarDecl(Id("a"), [], None),
                                                                              VarDecl(Id("y"), [], None),
                                                                              VarDecl(Id("z"), [], None),
                                                                              VarDecl(Id("a"), [], None)], ([], []))])
        expect = str(Redeclared(Parameter(), "a"))
    ...
    #          VarDecl(Id("a"), [], None),
    #          FuncDecl(Id("main"), [],
    #                   ([VarDecl(Id("y"), [], None)], [Assign(Id("x"), Id("a")), Assign(Id("y"), Id("z"))]))])
    ...
    def test_undeclared_function_85(self):
        input = Program([VarDecl(Id("x"), [], IntLiteral(3)), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
                         FuncDecl(Id("main"), [], (
                         [VarDecl(Id("t"), [], None)], [Assign(Id("t"), Id("x")), Assign(Id("z"), Id("y"))]))])
        expect = str(TypeCannotBeInferred(Assign(Id('z'), Id('y'))))
        self.assertTrue(TestChecker.test(input, expect, 485))

    def test_undeclared_function_86(self):
        input = Program([VarDecl(Id("x"), [], None), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
                         FuncDecl(Id("main"), [], (
                         [VarDecl(Id("t"), [], IntLiteral(3))], [Assign(Id("t"), Id("x")), Assign(Id("z"), Id("y"))]))])
        expect = str(TypeCannotBeInferred(Assign(Id('z'), Id('y'))))
    ...
    def test_undeclared_function_88(self):
        input = Program([VarDecl(Id("x"), [], IntLiteral(3)), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
                         FuncDecl(Id("main"), [], ([VarDecl(Id("t"), [], None)], [Assign(Id("t"), Id("x")),
                                                                                  Assign(Id("z"), BinaryOp("+", Id("y"),
                                                                                                           IntLiteral(
                                                                                                               4))),
                                                                                  Assign(Id("z"),
                                                                                         BinaryOp("+.", Id("y"),
    ...
    def test_undeclared_function_89(self):
        input = Program([VarDecl(Id("x"), [], None), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
                         FuncDecl(Id("main"), [], ([VarDecl(Id("t"), [], IntLiteral(3))], [Assign(Id("t"), Id("x")),
                                                                                           Assign(Id("z"),
                                                                                                  BinaryOp("-", Id("y"),
                                                                                                           IntLiteral(
                                                                                                               3))),
    ...
    #     input = Program([VarDecl(Id("x"), [], None), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
    #                      FuncDecl(Id("main"), [], (
    #                      [VarDecl(Id("t"), [], None), VarDecl(Id("m"), [], FloatLiteral(2.1))],
    #                      [Assign(Id("x"), IntLiteral(3)), Assign(Id("t"), Id("x")),
    #                       Assign(Id("z"), BinaryOp("\\", Id("y"), Id("x"))),
    #                       Assign(Id("z"), BinaryOp("\\", Id("m"), Id("x")))]))])
        ...
        input = Program([VarDecl(Id("x"), [], None),
                         ...
                         FuncDecl(Id("main"), [], ([VarDecl(Id("t"), [], IntLiteral(3))],
                                                   [Assign(Id("t"), BinaryOp("*", IntLiteral(2), IntLiteral(0))),
                                                    Assign(Id("t"),
                                                           BinaryOp("*", IntLiteral(2), FloatLiteral(0.2)))]))])
    ...
    def test_undeclared_function_92(self):
        input = Program([VarDecl(Id("x"), [], None), VarDecl(Id("y"), [], None), VarDecl(Id("z"), [], None),
                         FuncDecl(Id("main"), [], ([VarDecl(Id("t"), [], None)], [
                             Assign(Id("t"), BinaryOp("+.", FloatLiteral(2.0), FloatLiteral(0.2))),
